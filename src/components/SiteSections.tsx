...
export function CapabilitiesSection() {
  return (
    <section id="capabilities" className="section-shell section-block section-tinted">
...
export function MoreWorkSection() {
  return (
    <section id="more-work" className="section-shell section-block">
...
export function WritingSection({ posts }: { posts: MediumPost[] }) {
  return (
    <section id="writing" className="section-shell section-block section-tinted">
...
export function BackgroundSection() {
  return (
    <section id="background" className="section-shell section-block">
